...
// api/thanks-led.js - IMPROVED PREMIUM DARK VERSION
module.exports = (req, res) => {
  ...
  const svg = `
    <svg width="800" height="180" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="thanksBg" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <!-- Main background -->
      <rect width="100%" height="100%" fill="#1a1a2e" rx="25"/>
      <rect width="796"// api/header.js - PREMIUM DARK THEME
module.exports = (req, res) => {
