module.exports = (req, res) => {
  const count = Math.floor(Math.random() * 8000) + 3000;
  
  const svg = `<svg width="350" height="120" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <pattern id="grid" x="0" y="0" width="// api/header.js - PREMIUM ANIMATED VERSION
module.exports = (req, res) => {
